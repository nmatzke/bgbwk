...
#######################################################
# Getting your results into a results table
#######################################################

# The results have been saved in these objects:
# resDEC, resDECj, resDIVALIKE, resDIVALIKEj, resBAYAREALIKE, resBAYAREALIKEj
