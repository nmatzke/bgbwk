...
BioGeoBEARS_run_object$distsfn = np(paste(addslash(extdata_dir), "examples/Psychotria_M4_dists/Hawaii_KOMH_distances_max1.txt", sep=""))
...
#BioGeoBEARS_run_object$areas_adjacency_fn = "areas_adjacency.txt"
BioGeoBEARS_run_object$distsfn = np(paste(addslash(extdata_dir), "examples/Psychotria_M4_dists/Hawaii_KOMH_distances_max1.txt", sep=""))
BioGeoBEARS_run_object$envdistsfn = np(paste(addslash(extdata_dir), "examples/Psychotria_M4_dists/Hawaii_KOMH_distances_max1.txt", sep=""))
# See notes on the distances model on PhyloWiki's BioGeoBEARS updates page.
...
BioGeoBEARS_run_object$BioGeoBEARS_model_object@params_table["x","min"] = -10
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Psychotria M4_distances"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Psychotria M4_distances"
...
runslow = TRUE
resfn = "Psychotria_DIVALIKE_M4_distances_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Psychotria_DIVALIKE+J_M4_distances_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Psychotria M4_distances"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Psychotria M4_distances"
...
runslow = TRUE
resfn = "Psychotria_BAYAREALIKE_M4_distances_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Psychotria_BAYAREALIKE+J_M4_distances_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Psychotria M4_distances"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Psychotria M4_distances"
