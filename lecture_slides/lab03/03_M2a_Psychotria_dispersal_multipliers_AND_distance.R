...
runslow = TRUE
resfn = "Psychotria_DEC_M2a+x_oneWayDispersal_v1.Rdata"
if (runslow)
    {
...
resfn = "Psychotria_DEC+J_M2a+x_oneWayDispersal_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "Psychotria_DEC_vs_DEC+J_M2a+x_oneWayDispersal_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Psychotria M2a+x_oneWayDispersal"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Psychotria M2a+x_oneWayDispersal"
...
runslow = TRUE
resfn = "Psychotria_DIVALIKE_M2a+x_oneWayDispersal_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Psychotria_DIVALIKE+J_M2a+x_oneWayDispersal_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Psychotria_DIVALIKE_vs_DIVALIKE+J_M2a+x_oneWayDispersal_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Psychotria M2a+x_oneWayDispersal"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Psychotria M2a+x_oneWayDispersal"
...
runslow = TRUE
resfn = "Psychotria_BAYAREALIKE_M2a+x_oneWayDispersal_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Psychotria_BAYAREALIKE+J_M2a+x_oneWayDispersal_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Psychotria_BAYAREALIKE_vs_BAYAREALIKE+J_M2a+x_oneWayDispersal_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Psychotria M2a+x_oneWayDispersal"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Psychotria M2a+x_oneWayDispersal"
