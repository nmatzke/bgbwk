...
wd = "/GitHub/bgbwk/Psychotria_M0_equalRates/"
setwd(wd)
...
np(paste(addslash(extdata_dir), "examples/Psychotria_M3strat/BGB/", "dispersal_multipliers.txt", sep=""))
...
runslow = TRUE
resfn = "Psychotria_DEC_M3_unconstrained_v1.Rdata"
if (runslow)
    {
